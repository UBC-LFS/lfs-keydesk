...
<h1>Key Request Form for LFS Students</h1>
...
<form id="form1" method="post" action="process.php">
  ...
  <td>
  <label for="remail">Key Recipient's Student Number </label>
  </td><td>
  <input type="number" required name="rstudnum" max="99999999">
  </td>
  </tr><tr>
  <td>
  ...
  <td>
  <label for="rappt">Do you have a student appointment? </label>
  </td><td>
  <p>
  If you do, type in the faculty or department here at UBC that appointed
  you.  Otherwise, type in No.
  </p>
  <input type="text" required name="rappt"  maxlength="25">
  </td>
  </tr><tr>
  <td>
