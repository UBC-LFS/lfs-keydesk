...
<h1>Key Request Form for LFS Employees</h1>
...
<form id="form1" method="post" action="process.php">
  ...
  <td>
  <label for="remail">Key Recipient's Employee ID: </label>
  </td><td>
  <input type="number" required name="remid"  max="9999999" >
  </td>
  </tr><tr>
  <td>
  ...
  A comma separated list.  Type in fob for key card access.
  </td><td>
